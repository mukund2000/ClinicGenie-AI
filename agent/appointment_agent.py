...
from shared.observability import get_logger, observe_operation
...
patients, retrieve patient appointment history, and search for doctor availability
by date range using the available tools.
...
- To search doctors by date range: start date and end date.
- To search specific doctor availability by date range: doctor name, start date, and end date.
...
Formatting rules:
- Use DD-MM-YYYY for availability dates and date ranges.
